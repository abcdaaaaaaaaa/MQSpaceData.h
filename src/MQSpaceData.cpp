...
float MQSpaceData::MQ309ADataLowCO(){_va = 2336.2698;_vb = -1.7255;return limitValue1000(readValue());}
float MQSpaceData::MQ309ADataSecondH2(){_va = 25051.8177;_vb = -0.8318;return limitValue3000(readValue());}
