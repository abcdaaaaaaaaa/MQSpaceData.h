...
void MQSpaceData::SensorCalPer(float per)
{
 _percentile = per;
}
...
float MQSpaceData::CorrectionCoefficient()
{
	
}

const int CleanAir = 1;
String SensorName, SensorMode, FormulaMode;
int FormulaCoefficient, CRMode;
bool AirVals, AirValsEqualGasVals;
double Air, CalibrateAir, MinAirPpm, MaxAirPpm, SensorRLCalRL;
double a_RH30, b_RH30, a_RH33, b_RH33, a_RH60, b_RH60, a_RH85, b_RH85;
...
vector<GasParam> gas_params;

void group1_subgroup1();
void group1_subgroup2();
void group1_subgroup3();
void group1_subgroup4();
void group1_subgroup5();
void group1_subgroup6();
void group2_subgroup1();
void group2_subgroup2();
void group2_subgroup3();
void group2_subgroup4();
void group3_subgroup1();
void group3_subgroup2();
void MQ_Calculation_Mode(const string& mode, double param1, bool param2, bool param3, double param4, double param5, double param6, const string& unit);

void MQ_Calculation_Mode(String set1, int set2, bool set3, bool set4, int set5, float set6, float set7, String set8) {
    SensorMode = set1;
