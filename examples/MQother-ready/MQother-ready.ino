...
// WARNING: if you don't know how to calibrateR0, upload calibrateR0-veryeasy.ino or calibrateR0-normal.ino (different calibraet method) codes 
//and it will give you how to define which values ​​on serial port screen

// WARNING: if you don't know how to define valuea and valueb, upload MQother-result.ino
//and it will give you how to define which values ​​on serial port screen