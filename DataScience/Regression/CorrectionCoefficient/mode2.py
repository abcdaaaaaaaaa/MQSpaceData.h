...
real_x_values = np.array([1, 2, 3, 4, 5, 7, 9, 11, 13])
degree_x_values = 5 * real_x_values - 15

MQ = input("Please define the sensor name: ")
input_values = input("Enter the Y (Rs/Ro) values in the following format: (y1, y2, y3, y4, y5, y7, y9, y11, y13), (y1, y2, y3, y4, y5, y7, y9, y11, y13): ")
...
fig.add_trace(go.Scatter(x=5 * new_x_values - 15, y=y_pred_RH33_full, mode='lines', line=dict(color=color_RH33), name=f'RH33 Regression: y = {a_RH33:.4f}x^{b_RH33:.4f} (R²={R_squared_RH33:.4f})'))
